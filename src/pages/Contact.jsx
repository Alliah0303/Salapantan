...
const Contact = () => {
  ...
  return(
      <section className="bg-[#A020F0] text-center pt-[2rem]" id='contact'>
          <h2 className="text-[1.5rem] text-[#fff] font-semibold"data-aos="flip-left" data-aos-duration="2000" >CONNECT WITH ME</h2>
          <p className="text-[.8rem] text-[#000] tracking-[.5rem]" data-aos="flip-left" data-aos-duration="2000" >ON MY SOCIAL NETWORKS OR EMAIL</p>
        ...
        <img src={twitter} alt="Twitter" className="icon-small" />
          ...
          <div className='gmail my-[2rem]'>
              <a href="mailto:salapantan.judealliahsit2011@gmail.com" target='-blank' className="email font-medium">
                  <p className='mt-[.5rem] md:tracking-[.1rem] text-[.rem] ' >salapantan.judealliahsit2011@gmail.com</p>
              </a> 
          </div>
