...
const Contact = () => {
  ...
  return(
      <section className="bg-[#A020F0] text-center pt-[2rem]" id='contact'>
          ...
          <ul className="social-icons flex flex-col items-center justify-center gap-[3rem] mt-[3rem] sm:flex-row"> 
          ...
          <div className='gmail my-[3rem]'>
              <a href="mailto:salapantan.judealliahsit2011@gmail.com" target='-blank' className="email font-medium">
                  <p className='md:tracking-[.5rem]'data-aos="fade-up-right" data-aos-duration="1000" >salapantan.judealliahsit2011@gmail.com</p>
              </a> 
          </div>
