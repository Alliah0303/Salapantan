    ...
    return(
        <section className="home pb-[2rem] flex flex-col justify-between md:flex-row md:pb-[0] md:h-[100vh] w-[100%] relative overflow-hidden" id="home">
            <div className="px-[1rem] flex py-[1rem] flex-col items-center gap-[5rem] md:w-[50%] lg:px-[5rem]">
                <nav className="w-[100%]">
                <h1 className="text-[#EBD3F8] font-medium text-[1.2rem] lg:text-[1.5rem]">JUDE ALLIAH SALAPANTAN</h1>
                ...
                <div className="self-center">
                   ...
                   <h1 className=" "></h1>
                   <TypingAnimation
                    className="text-[#EBD3F8] text-[2rem]  pt-[2rem] font-oswald md:text-[3.5rem] lg:text-[4rem]"
